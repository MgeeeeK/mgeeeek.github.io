...
const BOOKS: Book[] = [
  ...
  { img: 'book-missing-milk', cx: 180, cy: 483, r: 0 },
  // 724:98 — bbox left 243 top 400 (224.995 x 297.268), inner rotate 5.3deg
  { img: 'book-other-girl', cx: 355.4975, cy: 548.634, r: 5.3 },
  // 724:97 — bbox left 413 top 318 (246.888 x 311.276), inner rotate -10.31deg
  { img: 'book-train-tracks', cx: 536.444, cy: 473.638, r: -10.31 },
]
...
function DesktopCanvas() {
  return (
    <div className={styles.canvas} aria-label="Fun stuff — Abhi's secret folder">
      <Header />

      {/* 26:231 */}
      <h1 className={styles.title}>You&rsquo;ve stumbled upon my secret folder</h1>
      {/* 26:232 */}
      <p className={styles.subtitle}>Here&rsquo;s what I write and design for fun</p>

      {/* 410:76 */}
      <h2 className={styles.shortStories}>Short Stories</h2>
      {/* 724:105 (typo "Illustartion" preserved verbatim from Figma) */}
      <h2 className={styles.designHeading}>Design, Illustartion &amp; Animation</h2>
      ...
      <div className={styles.bookTextWrapTracks}>
      ...
      <div className={styles.bottleNeck} aria-hidden="true" />
      ...
      <span className={styles.viewDesign}>View Design Portfolio</span>
  ...
  return (
    <div className={styles.mobile}>
      ...
      <section className={styles.mobileHero}>
        <h1>You&rsquo;ve stumbled upon my secret folder</h1>
        <p className={styles.mobileSubhead}>Here&rsquo;s what I write and design for fun</p>
      </section>
      ...
      <section className={styles.mobileSection}>
        ...
        <div className={styles.mobileBooks}>
          {BOOKS.map((book) => (
            <div key={book.img} className={styles.mobileBook}>
              <Image
                src={`${ASSET}/${book.img}.svg`}
                alt=""
                fill
      ...
      <section className={styles.mobileSection}>
        <h2>Design, Illustartion &amp; Animation</h2>
        <a
      ...
      <div className={styles.mobileButtons}>
        <Link href="/#work" className={styles.mobilePrimaryButton}>
          Go Back to Projects
        </Link>
        <Link href="/#contact" className={styles.mobileSecondaryButton}>
          Get in Touch
        </Link>
      </div>
    </div>
