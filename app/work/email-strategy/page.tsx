...
const NEXT = getNextProject('email-strategy')
...
function Arrow({
  ...
  return (
    <div
      ...
      data-reveal={revealDelay === undefined ? undefined : 'fade'}
...
function DesktopCanvas() {
  return (
    <ScaledCanvas className={styles.canvas} ariaLabel="Email Strategy case study" height={2642}>
      ...
      <p className={styles.subtitle} data-reveal="rise" data-reveal-delay="1">Keeping new users active and engaged via email strategy</p>

      {/* Intro paragraph */}
      <p className={styles.intro} data-reveal="rise" data-reveal-delay="2">
      ...
      {/* ── The Problem ── */}
      <p className={styles.problem} data-reveal="rise" data-reveal-delay="3">
      ...
      {/* ── The Solution ── */}
      <p className={styles.solution} data-reveal="rise">
      ...
      {/* Solution body */}
      <div className={styles.solutionBody} data-reveal="rise" data-reveal-delay="1">
        <p>
      ...
      {/* ── Tone of Voice ── */}
      <p className={styles.toneHeading} data-reveal="rise">
        <span>Tone of Voice</span>
      </p>
      <div className={styles.toneBody} data-reveal="rise" data-reveal-delay="1">
        <p>
      ...
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img className={styles.dia1} src={`${A}/vector2.svg`} alt="" data-reveal="stamp" />
      <div className={styles.route1Label} data-reveal="stamp">
        <p className={styles.fcBold}>Route 1: </p>
        <p className={styles.fcReg}>Founders &amp; Team Leaders</p>
      </div>

      {/* Arrow from Route 1 down to first pill */}
      <Arrow left={260} top={724} len={73} src={`${A}/arrow6.svg`} revealDelay={1} />

      {/* Pill: Emails explaining how MyCheckins helps teams */}
      <div className={styles.pillR1A} data-reveal="tilt" data-reveal-delay="2" />
      <p className={styles.pillR1AText} data-reveal="tilt" data-reveal-delay="2">
        Emails explaining how
        <br />
        MyCheckins helps teams
      </p>

      <Arrow left={180} top={846} len={50} src={`${A}/arrow3.svg`} revealDelay={0} />
      <Arrow left={340} top={847} len={109} src={`${A}/arrow1.svg`} revealDelay={0} />

      {/* Diamond: vector3 (Scenario A) */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img className={styles.dia2} src={`${A}/vector3.svg`} alt="" data-reveal="stamp" data-reveal-delay="1" />
      <p className={styles.scenA1} data-reveal="stamp" data-reveal-delay="1">
      ...
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img className={styles.dia3} src={`${A}/vector3.svg`} alt="" data-reveal="stamp" data-reveal-delay="2" />
      <p className={styles.scenB1} data-reveal="stamp" data-reveal-delay="2">
      ...
      <Arrow left={180} top={989} len={86} src={`${A}/arrow10.svg`} revealDelay={0} />
      <Arrow left={341} top={1048} len={185} src={`${A}/arrow13.svg`} revealDelay={1} />

      {/* Pill: Wrap-up email (Route 1) */}
      <div className={styles.pillR1B} data-reveal="tilt" data-reveal-delay="2" />
      <p className={styles.pillR1BText} data-reveal="tilt" data-reveal-delay="2">Wrap-up email with monthly hours saved and other stats</p>

      {/* Pill: One last nudge (Route 1) */}
      <div className={styles.pillR1C} data-reveal="tilt" data-reveal-delay="3" />
      <p className={styles.pillR1CText} data-reveal="tilt" data-reveal-delay="3">One last nudge with predictive  hours saved </p>

      {/* ── Route 2 ── */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img className={styles.dia4} src={`${A}/vector5.svg`} alt="" data-reveal="stamp" data-reveal-delay="1" />
      <div className={styles.route2Label} data-reveal="stamp" data-reveal-delay="1">
        <p className={styles.fcBold}>Route 2: </p>
        <p className={styles.fcReg}>Team Members</p>
      </div>

      <Arrow left={598} top={937} len={66.327} src={`${A}/arrow15.svg`} revealDelay={2} />

      {/* Pill: Emails describing how MyCheckins helps stay organised */}
      <div className={styles.pillR2A} data-reveal="tilt" data-reveal-delay="3" />
      <p className={styles.pillR2AText} data-reveal="tilt" data-reveal-delay="3">Emails describing how MyCheckins helps stay organised</p>

      <Arrow left={522} top={1059} len={41} src={`${A}/arrow16.svg`} revealDelay={1} />
      <Arrow left={681} top={1076} len={109} src={`${A}/arrow1.svg`} revealDelay={1} />

      {/* Diamond: vector5 (Scenario A, Route 2) */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img className={styles.dia5} src={`${A}/vector5.svg`} alt="" data-reveal="stamp" data-reveal-delay="2" />
      <p className={styles.scenA2} data-reveal="stamp" data-reveal-delay="2">
        <span className={styles.fcBold}>Scenario A: </span>
        <span>
          <br />
      ...
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img className={styles.dia6} src={`${A}/vector5.svg`} alt="" data-reveal="stamp" data-reveal-delay="3" />
      <p className={styles.scenB2} data-reveal="stamp" data-reveal-delay="3">
        <span>
          Scenario B: <br />
        </span>
        <span className={styles.fcReg}>Team member doesn’t make regular check-ins</span>
      </p>

      <Arrow left={522} top={1210} len={132} src={`${A}/arrow17.svg`} revealDelay={0} />
      <Arrow
        left={679}
        top={1296}
        len={178.975}
      ...
      <div className={styles.pillR2B} data-reveal="tilt" data-reveal-delay="2" />
      <p className={styles.pillR2BText} data-reveal="tilt" data-reveal-delay="2">Wrap-up email with monthly hours saved and other stats</p>

      {/* Pill: One last nudge (Route 2) */}
      <div className={styles.pillR2C} data-reveal="tilt" data-reveal-delay="3" />
      <p className={styles.pillR2CText} data-reveal="tilt" data-reveal-delay="3">One last nudge with predictive  hours saved </p>

      {/* Mic illustration */}
      <div className={styles.micBox} data-reveal="pop" data-reveal-delay="2">
      ...
      <p className={styles.resultPink} data-reveal="rise" data-reveal-delay="1">
        Uncertainty was reduced{' '}
        <br />
        <br />
      </p>
      <p className={styles.resultBody} data-reveal="rise" data-reveal-delay="2">
      ...
      {/* Stats row 1 labels */}
      <p className={styles.statLbl} style={{ left: 81, top: 2056.5, width: 102 }} data-reveal="rise">
        Activation rate increased from
      </p>
      <p className={styles.statLbl} style={{ left: 220, top: 2056.5, width: 120 }} data-reveal="rise" data-reveal-delay="1">
        Improved Week 1 retention from
      </p>
      <p className={styles.statLbl} style={{ left: 380, top: 2056.5, width: 120 }} data-reveal="rise" data-reveal-delay="2">
        Reduced early drop-off from
      </p>
      <p className={styles.statLbl} style={{ left: 537, top: 2056.5, width: 152 }} data-reveal="rise" data-reveal-delay="3">
        Increased product adoption from{' '}
      </p>

      {/* Stats row 1 values */}
      <p className={styles.statVal} style={{ left: 81, top: 2094.5 }} data-reveal="stamp">
        <span className={styles.statFrom}>32% → </span>
        <span className={styles.statTo}>41%</span>
      </p>
      <p className={styles.statVal} style={{ left: 220, top: 2094.5 }} data-reveal="stamp" data-reveal-delay="1">
        <span className={styles.statFrom}>11% → </span>
        <span className={styles.statTo}>16%</span>
      </p>
      <p className={styles.statVal} style={{ left: 380, top: 2094.5 }} data-reveal="stamp" data-reveal-delay="2">
        <span className={styles.statFrom}>23% → </span>
        <span className={styles.statTo}>18%</span>
      </p>
      <p className={styles.statVal} style={{ left: 537, top: 2094.5 }} data-reveal="stamp" data-reveal-delay="3">
        <span className={styles.statFrom}>27% → </span>
        <span className={styles.statTo}>38%</span>
      </p>

      {/* Stats row 2 labels */}
      <p className={styles.statLbl2} style={{ left: 80, top: 2207.5, width: 181 }} data-reveal="rise">
        For the first email, achieved an <br />
        open rate of
      </p>
      <p className={styles.statLbl2} style={{ left: 238, top: 2207.5, width: 177 }} data-reveal="rise" data-reveal-delay="1">
        Throughout the <br />
        journey, achieved <br />
        an open rate of
      </p>
      <p className={styles.statLbl2} style={{ left: 390, top: 2207.5, width: 91 }} data-reveal="rise" data-reveal-delay="2">
        Maintained click through rates of
      </p>

      {/* Stats row 2 values */}
      <p className={styles.statTo2} style={{ left: 80, top: 2263.5, width: 99 }} data-reveal="stamp">
        48%
      </p>
      <p className={styles.statTo2} style={{ left: 238, top: 2263.5, width: 142 }} data-reveal="stamp" data-reveal-delay="1">
        32-42%
      </p>
      <p className={styles.statTo2} style={{ left: 390, top: 2263.5, width: 142 }} data-reveal="stamp" data-reveal-delay="2">
        6-8%
      </p>
      ...
      <div className={`${styles.btnSlot} ${styles.btnSlotSecondary}`} data-reveal="pop" data-reveal-delay="1">
        <Magnetic>
  ...
  return (
    <div className={styles.mobile}>
      ...
      <section className={styles.mobileSection}>
        <h1 data-reveal="rise">Designing Retention for SaaS</h1>
        <p className={styles.mobileSub} data-reveal="rise" data-reveal-delay="1">Keeping new users active and engaged via email strategy</p>
      ...
      <section className={styles.mobileSection}>
        <h2 data-reveal="rise">Tone of Voice</h2>
        <p className={styles.mobilePink} data-reveal="rise" data-reveal-delay="1">Conversational, approachable, and grounded</p>
        <p data-reveal="rise" data-reveal-delay="2">
      ...
      <section className={styles.mobileSection}>
        <h2 data-reveal="rise">The Result:</h2>
        <p className={styles.mobilePink} data-reveal="rise" data-reveal-delay="1">Uncertainty was reduced</p>
        <p data-reveal="rise" data-reveal-delay="2">
        ...
        <ul className={styles.mobileStats} data-reveal="rise" data-reveal-delay="2">
