...
const PHOTOS: Photo[] = [
  ...
  { img: 'slack-wrapup.jpg', cx: 286.73 + 295.027 / 2, cy: 2484 + 427.298 / 2, w: 271.728, h: 412.331, rot: 3.3, alt: 'Slack wrap-up creative' },
  // Asset 20 1 — wrapper l309 t1185 w260.449 h374.507, inner 188.777×340.837, rot 12.97
  { img: 'album-asset-20.png', cx: 309 + 260.449 / 2, cy: 1185 + 374.507 / 2, w: 188.777, h: 340.837, rot: 12.97, alt: 'Intuit-themed AI album cover' },
  // Asset 22 1 — wrapper l180 t1077 w202.849 h352.21, inner 192.302×346.469, rot -1.76
  { img: 'album-asset-22.png', cx: 180 + 202.849 / 2, cy: 1077 + 352.21 / 2, w: 192.302, h: 346.469, rot: -1.76, alt: 'Intuit-themed AI album cover' },
  // Asset 21 1 — wrapper l80 t1314 w271.725 h373.994, inner 185.209×335.569, rot -16.25
  { img: 'album-asset-21.png', cx: 80 + 271.725 / 2, cy: 1314 + 373.994 / 2, w: 185.209, h: 335.569, rot: -16.25, alt: 'Intuit-themed AI album cover' },
  // Group 49 1 (microsite) — wrapper l628.8 t1916.81 w350.203 h502.899, inner 346×500, rot -0.48
  { img: 'microsite-group49.png', cx: 628.8 + 350.203 / 2, cy: 1916.81 + 502.899 / 2, w: 346, h: 500, rot: -0.48, alt: 'Album-maker microsite interface' },
  // image (6) 1 — wrapper l65.73 t2264 w442.725 h275.342, inner 422.831×237.843, rot -5.22
  { img: 'image-6.png', cx: 65.73 + 442.725 / 2, cy: 2264 + 275.342 / 2, w: 422.831, h: 237.843, rot: -5.22, alt: 'Wrap party event collateral' },
  // IMG_2013 1 — wrapper l119.11 t2482.8 w218.973 h282.236, inner 202.683×270.244, rot -3.54
  { img: 'img-2013.jpg', cx: 119.11 + 218.973 / 2, cy: 2482.8 + 282.236 / 2, w: 202.683, h: 270.244, rot: -3.54, alt: 'T-shirt printing workshop photo' },
  // Communication mailer_4th Sep_1 1 — wrapper l71.54 t4414.97 w528.886 h906.978, inner 380×852, rot -10.5
  { img: 'mailer-communication.jpg', cx: 71.54 + 528.886 / 2, cy: 4414.97 + 906.978 / 2, w: 380, h: 852, rot: -10.5, alt: 'Communication mailer design' },
  // Ganesh Chathurthi_Mailer_21st Aug 1 — wrapper l465 t4608 w440.261 h706.072, inner 370×670, rot 6.21
  { img: 'mailer-ganesh.jpg', cx: 465 + 440.261 / 2, cy: 4608 + 706.072 / 2, w: 370, h: 670, rot: 6.21, alt: 'Ganesh Chaturthi mailer design' },
  // Parenting-Series-Mailer_2 1 — wrapper l154.54 t5210.3 w534.785 h1009.778, inner 382×960, rot 9.47
  { img: 'mailer-parenting.jpg', cx: 154.54 + 534.785 / 2, cy: 5210.3 + 1009.778 / 2, w: 382, h: 960, rot: 9.47, alt: 'Parenting series mailer design' },
  // WhatsApp Image 2026-05-18 — wrapper l568 t5183 w530.456 h741.19, inner 386.255×670.152, rot -13.34
  { img: 'whatsapp-mailer.jpg', cx: 568 + 530.456 / 2, cy: 5183 + 741.19 / 2, w: 386.255, h: 670.152, rot: -13.34, alt: 'PineLabs corporate emailer design' },
]

// Lime stars (Star 17) — l/t of the 20×21 box.
const STARS = [
  { l: 78.73, t: 693 },
  { l: 658.73, t: 793 },
  { l: 678.73, t: 793 },
...
function DesktopCanvas() {
  return (
    <div className={styles.canvas} aria-label="Internal Communications case study">
      <Header />

      {/* ===== Section 1: AI Powered Microsite Innovation ===== */}
      <h1 className={styles.h1} style={{ left: 80, top: 153, width: 888 }}>
        AI Powered Microsite Innovation
      </h1>
      <p className={styles.subhead} style={{ left: 80, top: 222, width: 776 }}>
      ...
      <p className={styles.body} style={{ left: 720, top: 280, width: 319, height: 368 }}>
      ...
      {/* Step 1 */}
      <p className={styles.stepHead} style={{ left: 78.73, top: 717, width: 65 }}>
        Step 1
      </p>
      <p className={styles.body} style={{ left: 78.73, top: 757, width: 320, height: 170 }}>
      ...
      {/* Step 2 */}
      <p className={styles.stepHead} style={{ left: 658.73, top: 817, width: 96 }}>
        Step 2
      </p>
      <p className={styles.body} style={{ left: 667.73, top: 868, width: 300, height: 204 }}>
      ...
      <div
        ...
        aria-hidden="true"
      />
      <div className={styles.body} style={{ left: 678.73, top: 1086, width: 285, height: 317 }}>
        <p style={{ margin: 0 }}>
      ...
      <p className={styles.numTag} style={{ left: 959.73, top: 1138 }}>1</p>
      <p className={styles.numTag} style={{ left: 672.73, top: 1204 }}>1</p>
      <p className={styles.numTag} style={{ left: 949.73, top: 1154 }}>2</p>
      <p className={styles.numTag} style={{ left: 672.73, top: 1273 }}>2</p>
      <p className={styles.numTag} style={{ left: 672.73, top: 1340 }}>3</p>

      {/* Step 3 */}
      <p className={styles.stepHead} style={{ left: 558.73, top: 1677, width: 80 }}>
        Step 3
      </p>
      <div className={styles.body} style={{ left: 558.73, top: 1716, width: 300, height: 295 }}>
        <p style={{ margin: 0 }}>
      ...
      {/* Step 4 */}
      <p className={styles.stepHead} style={{ left: 77.73, top: 2098, width: 491 }}>
        Step 4
      </p>
      <div className={styles.body} style={{ left: 77.73, top: 2133, width: 303, height: 116 }}>
        <p style={{ margin: 0 }}>
      ...
      <div className={styles.csrBand} style={{ left: 0, top: 3067, width: 1280, height: 680 }} aria-hidden="true" />
      <h1 className={styles.h1} style={{ left: 80, top: 3127, width: 1140, height: 170 }}>
        Reimagining CSR as an Interactive Classroom
      </h1>
      <p className={styles.subhead} style={{ left: 80, top: 3196, width: 776 }}>
        Intuit Rise: From India to Global
      </p>
      <div className={styles.body} style={{ left: 80, top: 3249, width: 260, height: 398 }}>
        <p style={{ margin: 0 }}>
      ...
      <h1 className={styles.h1} style={{ left: 80, top: 3960, width: 900 }}>
        Recipe for Perfect Corporate Emailers
      </h1>
      <p className={styles.subhead} style={{ left: 80, top: 4029, width: 776 }}>
        As seen on PineLabs
      </p>

      {/* recipe ingredient list (Playfair) */}
      <p className={styles.recipeItalic} style={{ left: 100, top: 4285, width: 340 }}>1 Cup</p>
      <p className={styles.recipeReg} style={{ left: 100, top: 4305, width: 248 }}>Clear Communication</p>
      <p className={styles.recipeItalic} style={{ left: 601, top: 4285, width: 276 }}>1 Tablespoon</p>
      <p className={styles.recipeReg} style={{ left: 601, top: 4305, width: 248 }}>Warmth &amp; Human-ness</p>
      <p className={styles.recipeItalic} style={{ left: 428, top: 4165, width: 340 }}>A Sprinkle of</p>
      <p className={styles.recipeReg} style={{ left: 428, top: 4185, width: 248 }}>Humour</p>
      <p className={styles.recipeItalic} style={{ left: 100, top: 4685, width: 100 }}>1 Cup</p>
      ...
      {/* ===== Footer buttons ===== */}
      <Link className={styles.primaryButton} href="/#work" style={{ left: 60, top: 6339 }}>
        Next Project
      </Link>
      <Link className={styles.secondaryButton} href="/#contact" style={{ left: 273, top: 6340 }}>
        Get in Touch
      </Link>
    </div>
  )
  ...
  return (
    <div className={styles.mobile}>
      ...
      <section className={styles.mobileSection}>
        <h1>AI Powered Microsite Innovation</h1>
        <p className={styles.mobileSubhead}>Intuit&rsquo;s Greatest Hits</p>
        <div className={styles.mobileEmbed} aria-hidden="true" />
        <p>
          Intuit India hit 2,000 employees and wanted to celebrate with something big. The goal was to create a
          digital-first experience that gave every employee a custom keepsake. It had to be easy to execute and
          uncomplicated for users.
        ...
        <div className={styles.mobileGrid}>
          <Image src={`${ASSET}/album-asset-22.png`} alt="Intuit-themed AI album cover" width={192} height={346} />
          <Image src={`${ASSET}/album-asset-20.png`} alt="Intuit-themed AI album cover" width={189} height={341} />
          <Image src={`${ASSET}/album-asset-21.png`} alt="Intuit-themed AI album cover" width={185} height={336} />
          <Image src={`${ASSET}/microsite-group49.png`} alt="Album-maker microsite interface" width={346} height={500} />
        </div>
        ...
        <div className={styles.mobileGrid}>
          <Image src={`${ASSET}/image-6.png`} alt="Wrap party event collateral" width={423} height={238} />
          <Image src={`${ASSET}/img-2013.jpg`} alt="T-shirt printing workshop photo" width={203} height={270} />
          <Image src={`${ASSET}/slack-wrapup.jpg`} alt="Slack wrap-up creative" width={272} height={412} />
        </div>
      </section>

      <section className={`${styles.mobileSection} ${styles.mobileCsr}`}>
        <h2>Reimagining CSR as an Interactive Classroom</h2>
        <p className={styles.mobileSubhead}>Intuit Rise: From India to Global</p>
        <div className={styles.mobileEmbed} aria-hidden="true" />
        <p>
          The Intuit Rise Girl Child Empowerment Program supports underprivileged girls in India from 8th grade
          through graduation. It began as an initiative funded by Intuit employees in India and was opening up for
      ...
      <section className={styles.mobileSection}>
        <h2>Recipe for Perfect Corporate Emailers</h2>
        <p className={styles.mobileSubhead}>As seen on PineLabs</p>
        <ul className={styles.mobileRecipe}>
          <li><em>1 Cup</em> Clear Communication</li>
          <li><em>1 Tablespoon</em> Warmth &amp; Human-ness</li>
          <li><em>A Sprinkle of</em> Humour</li>
        </ul>
        <div className={styles.mobileGrid}>
          <Image src={`${ASSET}/mailer-communication.jpg`} alt="Communication mailer design" width={380} height={852} />
          <Image src={`${ASSET}/mailer-ganesh.jpg`} alt="Ganesh Chaturthi mailer design" width={370} height={670} />
          <Image src={`${ASSET}/whatsapp-mailer.jpg`} alt="PineLabs corporate emailer design" width={386} height={670} />
          <Image src={`${ASSET}/mailer-parenting.jpg`} alt="Parenting series mailer design" width={382} height={960} />
        </div>
