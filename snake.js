class SnakeGame {
  ...
  updateScore() {
    document.getElementById("snakeScore").textContent = this.score; // Changed from 'score'
    document.getElementById("snakeFinalScore").textContent = this.score; // Changed from 'finalScore'
  ...
  updateTimer() {
    ...
    document.getElementById("snakeTime").textContent =
      // Changed from 'time'
